...
function createSquare(width, height, bgColor, index = 'index') {
  ...
  const resizer = createResizeBox(40, 40)
...
function createResizeBox(width, height) {
  ...
  resizer.style.borderRight = '1px solid #000000'
  resizer.style.borderBottom = '1px solid #000000'

  const innerResizer = document.createElement('div')
  innerResizer.style.position = 'absolute'
  innerResizer.style.width = '80%'
  innerResizer.style.height = '80%'
  innerResizer.style.right = '1px'
  innerResizer.style.bottom = '1px'
  innerResizer.style.borderRight = '1px solid #000000'
  innerResizer.style.borderBottom = '1px solid #000000'

  const inner_innerResizer = document.createElement('div')
  inner_innerResizer.style.position = 'absolute'
  inner_innerResizer.style.width = '80%'
  inner_innerResizer.style.height = '80%'
  inner_innerResizer.style.right = '1px'
  inner_innerResizer.style.bottom = '1px'
  inner_innerResizer.style.borderRight = '1px solid #000000'
  inner_innerResizer.style.borderBottom = '1px solid #000000'
